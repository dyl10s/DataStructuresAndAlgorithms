...
const bool SimpleDate::isLeapYear(int year) {
...
const bool SimpleDate::isValidDate(int month, int day, int year) {
...
const int SimpleDate::daysInMonth(int month, int year) {
